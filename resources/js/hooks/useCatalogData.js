...
//   const [error, setError] = useState(null);
//   const [lastUpdated, setLastUpdated] = useState(null);
//   const [translationsLastUpdated, setTranslationsLastUpdated] = useState(null);
//   const [isPollingPaused, setIsPollingPaused] = useState(false); // Новое состояние для паузы пулинга
...
//     const interval = setInterval(async () => {
//       if (isPollingPaused) return; // Пропускаем пулинг, если он приостановлен
...
//             await i18n.reloadResources(i18n.language, 'translation');
//             console.log('Translations reloaded successfully');
//             await fetchData(); // Обновляем данные после перезагрузки переводов
//           } catch (reloadError) {
//             console.error('Failed to reload translations:', reloadError);
//           }
//         } else if (translationsLastUpdated === null) {
...
//   // Метод для приостановки и возобновления пулинга

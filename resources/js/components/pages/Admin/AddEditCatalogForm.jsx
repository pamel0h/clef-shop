...
// import i18n from '../../../i18n'; // Импортируем i18n для перезагрузки переводов
...
//   const { refetch: refetchAdminCatalog } = useCatalogData('admin_catalog'); // Добавляем refetch для admin_catalog
...
//         // Обновляем данные admin_catalog вручную

...
//   // Инициализация фильтров при изменении initialProducts
//   useEffect(() => {
//     console.log('ProductsList: Received initialProducts', JSON.stringify(initialProducts, null, 2));
//     const sortedProducts = sortProducts(initialProducts, sortOption.field, sortOption.direction);
...
//     const sortedFilteredByMain = sortProducts(filteredByMain, sortOption.field, sortOption.direction);
...
//     const sortedFilteredProducts = sortProducts(filteredBySpecs, sortOption.field, sortOption.direction);
//     console.log('ProductsList: Filtered products', JSON.stringify(sortedFilteredProducts, null, 2));
//     setFilteredProducts(sortedFilteredProducts);
//   };

//   const handleSortChange = (field, direction) => {
//     console.log(`ProductsList: Sorting filteredProducts with {field: '${field}', direction: '${direction}'}`);
//     setSortOption({ field, direction });
//     const sortedFilteredProducts = sortProducts(filteredProducts, field, direction);
//     setFilteredProducts(sortedFilteredProducts);
//   };
